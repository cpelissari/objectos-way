...
public class ExecutorTest {
  ...
  public void setUp() {
    ...
    commandMap.put(HelpCommand.NAME, new FakeMainCommand(HelpCommand.NAME));

    executor = new ExecutorGuice(commandMap);
  }
  ...
  public void when_command_not_found_should_default_to_help_command() {
    ...
    assertThat(executedCommand, equalTo(HelpCommand.NAME));
  }
